import { User, Profile, Ranked, ModeData } from "./types";
...
export class KookCardTemp {
  ...
  static RankInfoCard(
    ...
    profile: Profile,
    ranked: Ranked,
    s: "online" | "away" | "dnd" | "offline",
  ) {
    const status = handleOnlineStatus(s);
    let top = "";
    if (ranked.topRankPosition > 0)
      top = "冠军 **第" + ranked.topRankPosition + " **名 |";
        ...
        },
        {
          ...
          text: {
            ...
            fields: [
              ...
              {
                type: "plain-text",
                content: `${casual.winRate}`,
              },
              {
                type: "plain-text",
                content: `${casual.matches}`,
              },
              {
                type: "kmarkdown",
                content: "**击杀/死亡**",
              ...
              {
                type: "plain-text",
                content: `${casual.kills}-${casual.deaths}`,
              },
              {
                type: "plain-text",
                content: `${casual.wins}-${casual.losses}`,
              },
              {
                type: "plain-text",
                content: `${casual.abandons}`,
              },
            ],
          },
        },
        ...
        },
        {
          ...
          text: {
            ...
            fields: [
              ...
              {
                type: "plain-text",
                content: `${warmup.winRate}`,
              },
              {
                type: "plain-text",
                content: `${warmup.matches}`,
              },
              {
                type: "kmarkdown",
                content: "**击杀/死亡**",
              ...
              {
                type: "plain-text",
                content: `${warmup.kills}-${warmup.deaths}`,
              },
              {
                type: "plain-text",
                content: `${warmup.wins}-${warmup.losses}`,
              },
              {
                type: "plain-text",
                content: `${warmup.abandons}`,
              },
            ],
          },
        },
