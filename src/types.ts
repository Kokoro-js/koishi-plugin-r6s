...
export interface ProfileInfo {
  profileId: string;
  platform: "pc" | "console";
  season: { id: number; shorthand: string } | {
    id: number;
    shorthand: "Y0S0";
    slug: "release";
    name: string;
  ...
  board: {
    slug: "ranked" | "casual" | "warmup" | "event" | "newcomer";
    name: "Ranked" | "Casual" | "Deathmatch" | "Event" | "Newcomer"
  };
  rank: {
    id?: number | undefined;
...
export interface Profile { level: number;
  lootboxProbability: { raw: number; percent: string };
  xp: number;
